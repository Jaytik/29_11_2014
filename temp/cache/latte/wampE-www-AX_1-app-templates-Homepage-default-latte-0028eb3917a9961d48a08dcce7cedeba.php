<?php
// source: C:\wampE\www\AX_1\app/templates/Homepage/default.latte

// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('6945342615', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lb65a17ecbeb_content')) { function _lb65a17ecbeb_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
