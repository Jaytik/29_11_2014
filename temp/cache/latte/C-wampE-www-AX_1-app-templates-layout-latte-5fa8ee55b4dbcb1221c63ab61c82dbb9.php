<?php
// source: C:\wampE\www\AX_1\app/templates/@layout.latte

// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('6286177596', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block head
//
if (!function_exists($_b->blocks['head'][] = '_lb161f28a547_head')) { function _lb161f28a547_head($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
;
}}
...
// block scripts
//
if (!function_exists($_b->blocks['scripts'][] = '_lbd54e53af2a_scripts')) { function _lbd54e53af2a_scripts($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
