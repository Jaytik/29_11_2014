<?php
// source: C:\wampE\www\AX_1\app/config/config.neon 
// source: C:\wampE\www\AX_1\app/config/config.local.neon 
...
class SystemContainer extends Nette\DI\Container
{
	...
	protected $meta = array(
		'types' => array(
			...
			'app\\components\\vypis\\vypiscontrolfactory' => array(
				'22_App_Components_Vypis_VypisControlFactory',
			),
	...
	public function __construct()
	{
		parent::__construct(array(
			'appDir' => 'C:\\wampE\\www\\AX_1\\app',
			'wwwDir' => 'C:\\wampE\\www\\AX_1\\www',
			'debugMode' => TRUE,
			...
			'tempDir' => 'C:\\wampE\\www\\AX_1\\app/../temp',
		));
	}


	/**
	 * @return App\Components\Vypis\VypisControlFactory
	 */
	public function createService__22_App_Components_Vypis_VypisControlFactory()
	{
		return new SystemContainer_App_Components_Vypis_VypisControlFactoryImpl_22_App_Components_Vypis_VypisControlFactory($this);
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('C:\\wampE\\www\\AX_1\\app/../temp/cache', $this->getService('nette.cacheJournal'));
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileJournal('C:\\wampE\\www\\AX_1\\app/../temp');
		return $service;
	}
	...
	public function createServiceNette__latte()
	{
		...
		$service->setTempDirectory('C:\\wampE\\www\\AX_1\\app/../temp/cache/latte');
	...
	{
		$service = new Nette\Application\PresenterFactory('C:\\wampE\\www\\AX_1\\app', $this);
	...
	{
		$service = new Nette\Caching\Storages\PhpFileStorage('C:\\wampE\\www\\AX_1\\app/../temp/cache', $this->getService('nette.cacheJournal'));
...
final class SystemContainer_App_Components_Vypis_VypisControlFactoryImpl_22_App_Components_Vypis_VypisControlFactory implements App\Components\Vypis\VypisControlFactory
{
	...
	{
		$service = new App\Components\Vypis\VypisControl($this->container->getService('database.default.context'));
		return $service;
	}
